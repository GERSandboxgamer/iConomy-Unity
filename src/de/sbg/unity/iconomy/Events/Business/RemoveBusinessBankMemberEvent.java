...
public class RemoveBusinessBankMemberEvent extends Event implements Cancellable{
    
    private final Player player;
    private final BusinessBankMember Member;
    
    public RemoveBusinessBankMemberEvent(Player player, BusinessBankMember member) {
        this.player = player;
        this.Member = member;
    }
